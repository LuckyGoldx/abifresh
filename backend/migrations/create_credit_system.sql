...
CREATE TABLE IF NOT EXISTS credit_payments (
    ...
    remittance_status TEXT CHECK (remittance_status IN ('submitted', 'confirmed')),
    remitted_at TIMESTAMP,
    remittance_confirmed_at TIMESTAMP,
    remittance_confirmed_by UUID REFERENCES users(id),
