            ...
            {filteredItems.map((item) => (
              <div key={item.id} className="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition overflow-hidden flex flex-col h-full">
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">{item.category} • {item.sku}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Stock: {item.active_store_quantity}</p>
