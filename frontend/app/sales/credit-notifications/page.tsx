      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium italic">Live feed of all credit system activities</p>
          </div>
          ...
          {filteredNotifications.length > 0 ? (
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 font-medium leading-relaxed mb-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {notif.type.includes('confirmation') && (
                          <span className="flex items-center gap-1 text-[10px] font-bold text-gray-400 dark:text-gray-500">
                            <CheckCircle className="w-3 h-3 text-green-500" /> System Confirmed
                          </span>
                        )}
                      </div>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-20 text-center border-2 border-dashed border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto font-medium">
                When you give credit, receive payments, or return items, the notifications will appear here in real-time.
              </p>
            </div>
          )}
        </div>
