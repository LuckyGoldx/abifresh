...
import { Check, X, AlertCircle, CheckCircle, Clock, Eye, RefreshCw, User } from 'lucide-react';
...
export default function SuperAdminReturnedItemsPage() {
  ...
  const fetchData = async () => {
    try {
      setIsLoading(true);
      const res = await api.get('/api/admin/returned-items');
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            ...
            Superadmin: Returned Items
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Overview of all items returned by all staff members across the system
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                Returned Item Details (Superadmin View)
              </h2>
              <button
                onClick={() => {
                  setShowDetailModal(false);
