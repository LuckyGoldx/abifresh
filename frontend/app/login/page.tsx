    ...
    <div className={`${styles.body} ${isDarkMode ? styles.darkMode : ''}`}>
      ...
      <div className={styles.topLogo}>
        <svg className={styles.ribbonLogoTop} viewBox="10 28 240 55" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="130" y="75" fontFamily="'Plus Jakarta Sans',sans-serif" fontWeight="600" fontSize="10" fill={isDarkMode ? '#ffffff' : '#fbbf24'} textAnchor="middle" letterSpacing="3">&amp; KIDDIES VENTURES</text>
