      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-10">
          ...
          <button 
            ...
            className="flex items-center justify-center w-10 h-10 bg-pink-600 rounded-2xl text-white hover:bg-pink-700 transition-all shadow-lg shadow-pink-100 dark:shadow-none ml-auto"
          >
            <Download size={18} />
          </button>
        </div>
